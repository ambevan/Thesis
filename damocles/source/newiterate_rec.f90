RECURSIVE SUBROUTINE iterate(nu_p,dir_cart,pos_cart,iG_axis,iG,lgabs,lgactive,w,scatno)
    ...
    REAL    ::  V_T(3)
    REAL,parameter    ::  maxwell_sigma=3.89E2
    ...
    DO ispec=1,nspecies
        ...
        !calculate weighted albedo as well
        albdo=albdo+dust(ispec)%albedo(wavid2)*dust(ispec)%weight
    END DO
...
!    END IF
    ...
    IF ((s>s_min)) THEN
        ...
        CALL iterate(nu_p,dir_cart,pos_cart,iG_axis,iG,lgabs,lgactive,w,scatno)
        !PRINT*,'here3'
    ELSE
