...
!                       PRINT*,'this is working'
        ...
        DO j=1,nspecies
           ...
           lambda_sca=lambda_sca+dust(j)%weight*(dust(j)%sca_opacity(id)-((dust(j)%sca_opacity(id)-dust(j)%sca_opacity(id-1))* &
                & ((dust(j)%wav(id)-(lambda_0/1000))/(dust(j)%wav(id)-dust(j)%wav(id-1)))))
           lambda_ext_V=lambda_ext+dust(j)%weight*(dust(j)%ext_opacity(id_V)-((dust(j)%ext_opacity(id_V)-dust(j)%ext_opacity(id_V-1))* &
                & ((dust(j)%wav(id_V)-(lambda_0/1000))/(dust(j)%wav(id_V)-dust(j)%wav(id_V-1)))))
        END DO
