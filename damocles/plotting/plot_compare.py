...
wave3,dat3,flux_sil=np.loadtxt('line_sils.out',skiprows=1,usecols=(0,1,2),unpack=True)
wave4,dat3,flux_amC=np.loadtxt('line_amC.out',skiprows=1,usecols=(0,1,2),unpack=True)
lambda0=656.28
...
line_3=pl.plot(wave4,flux_amC,'g--',label='model - amC')
...
pl.legend(['model - perfect absn','model - amC','model - sil'])
#pl.savefig('line.eps')
#fig2=pl.figure()
