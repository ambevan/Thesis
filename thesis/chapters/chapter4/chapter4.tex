...
\section{The dust optical depth, $\tau$}
\label{tau}
...
\subsection{The detached shell case}
...
\subsection{The complete nebula case}
...
\section{The dust density profile, $\rho \propto r^{-2\beta}$}
\label{beta}
...
\section{The velocity distribution}
\label{scn:vel_prof}
