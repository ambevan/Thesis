...
%the required wing seen at early epochs.  I therefore adopt an approach 
%whereby, for a number of grain size ranges, I adjust the exponent of the 
%distribution until the overall albedo is the same as that seen for the 
%best fitting single grain radius for the clumped distributions.  I may 
