...
\label{damocles_struct}
	...
	\end{centering}
		...
		The \textit{random\_routine} module contains a single subroutine which is, like the \textit{BHmie} routine, a standard obtained from an online library.  It allows for a random velocity vector to be sampled from a normal distribution with specified mean and standard deviation.  The standard deviation is calculated 
