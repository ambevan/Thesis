...
I had mixed success in obtaining good fits to the oxygen line profiles of SN~1993J.  Certain aspects of the line profiles are well-fitted by my models, such as the bump seen at $-4000$~km~s$^{-1}$ in the [O {\sc iii}] line.  The peaks of the [O {\sc iii}] profile were fiarly well matched although I could not reproduce the peak seen at $+4000$~km~s$^{-1}$.  Similarly, I struggled to reproduce the shape of the profile betwen $-2000$ and $+2000$~km~s$^{-1}$ for both the [O {\sc iii}] and [O {\sc ii}] lines.  In order to fit the profile, I needed to use different sized grains for the [O {\sc iii}] and the [O {\sc ii}] models in order to fit the red wing of the profile.
...
\label{scn:discuss}
%%%DISCUSS 80K AS OBJECT TO DO%%%
DISCUSS 80K RELATIVE TO OTHER SNe.  
...
As ever, for both SN~1993J and SN~1980K, clumped distributions of dust be considered.
TALK ABOUT CLUMPING.  93J factor of 1.5.

NOW TALK ABOUT HOW THESE DUST MASS ESTIMATED FIT IN WITH OVERALL CURVE.
...
%TO DO TALK ABOUT CLUMPING AND RELATE TO DUST MASSES IN SNe IN GENERAL
