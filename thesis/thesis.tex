...
\thesistitle{Supernova dust masses from line profile models: \\ A new diagnostic}
\thesisauthor{Antonia Bevan}
\dedication{\it{DEDICATION}} 
\supervisorone{Mike Barlow}
\examinerone{MAIN EXAMINERS NAME}
\supervisortwo{Jeremy Yates}
\examinertwo{SECOND EXAMINERS NAME}
...
%% Appendices
\include{back/appendices/appendA}
\clearthesisemptydoublepage
...
\bibliographystyle{harthesis} % bib style file *.bst
\bibliography{thesis} % thesis.bib file containing references 
\clearemptydoublepage

%% Naff back quote

\include{back/backquote}
\clearemptydoublepage
