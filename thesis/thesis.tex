...
%% Two sided
%\documentclass[11pt, a4papter, twoside, openright, fleqn]{thesis}
...
% \usepackage[pdftex,bookmarks,colorltinks,breaklinks,backref]{hyperref}
...
\dedication{\it{In loving memory of Mollie and Bill Siddle.}} 
