...
\university{\vspace{1cm}\huge University College London}
\faculty{\Large Faculty of Mathematics and Physical Sciences}
\department{Department of Physics \& Astronomy}  
\thesistitle{\vspace{0.8cm} Dust-Affected Models of Characteristic Line Emission in Supernovae}
\thesisauthor{\LARGE ANTONIA BEVAN \vspace{0.8cm}}
