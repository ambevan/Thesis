...
The dependence of the shape of the line profile on the emissivity distribution when the dust is very optically thin 
is described analytically in Section \ref{analytics}.  However, the density profile 
also plays a significant role where there is even a small amount of 
absorption.  As previously discussed, at relatively small optical depths for reasonable $R_{in}/R_{out}$, 
...
$\beta$ with $\tau$ on the profiles is shown in Figure \ref{bt}.  As previously noted, these features may not be apparent in observed line profiles with poor spectral resolution as a result of blending.
...
$V_{min}$ value corresponding to the velocity at the inner radius of the shell unless this value is very small in comparison to $V_{max}$ i.e. the profile originally had a very narrow flat top.  
...
expect it potentially to trace the location of different ions within the ejecta with different $V_{min}$ observed for  
different species.  
...
[O~{\sc i}] $\lambda$6300,6363~\AA\ doublet at days 714 to 1478.  After day 3604 the H$\alpha$ profile begins to become dominated by emission from the reverse shock 
...
optical depth as previously discussed.  Figure \ref{MRN} illustrates the 
...
over- or under-estimating the red wing and the trough in the doublet.  We 
therefore conclude that the dust mass estimates produced for the H$\alpha$ lines at days 714 and 
806 for a grain radius of $a=0.6\mu$m are the best estimates of the dust mass 
at this epoch.  At much later epochs (days 1862 - 3604) for H$\alpha$ and for all epochs modelled for [O~{\sc i}] however we find that equally good fits may 
be generated by substantially larger grains, with grain radii up to $a=3.5\mu$m (see Figures \ref{OI_clump2} and 
...
a similar velocity to the 6583\AA\ line as any dust-induced features near this wavelength
 ...
 By day 1054, all three of the narrow nebular lines are strong.  They remain unresolved for the CTIO data at days 1054 and 1478 and therefore contaminate the entire central region of the H$\alpha$ line profile.  Their removal therefore renders the profiles unusable for modelling purposes.  The H$\alpha$ profiles at later epochs ($\ge$ 1862 days), however, have a higher resolution and it is therefore possible to remove these narrow [N~{\sc ii}] and H$\alpha$ lines from the broad profiles. Although this does remove a 
critical section of the line ($500$ km~s$^{-1}<v<1500$ km~s$^{-1}$) that 
would be potentially informative about $V_{min}$ we achieve good fits 
...
We find that at all epochs that the dust masses derived by W15 are entirely within the dust mass ranges predicted by our models.

It should be noted that our sigmoid fit is a simple fit to the mean of the maximum and minimum dust masses.  It does not take into account grain growth.  It seems likely that at earlier epochs, whilst grains are still small relative to later epochs, the lower end of our estimate is more representative than the upper end; the reverse would be true at later epochs.
