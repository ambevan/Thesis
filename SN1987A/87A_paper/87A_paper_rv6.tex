...
dust formation and that dust-affected line profiles need not 
...
that a large dust mass ($\ge 0.1M_{\odot}$) had formed by day 3604 and 
...
%\begin{figure}
%\includegraphics[trim =33 10 45 15,clip=true,scale=0.49]{silicate_models/MgSiO3_smooth_A}
%\caption{A smooth dust fit to the day 714 H$\alpha$ line profile using the \citet{Jager2003} optical constants for MgSiO$_3$ with the same parameters listed in Table \ref{smooth1} except for a dust mass of 0.055M$_{\odot}$ and a grain radius $a=0.01$.}
%\label{MgSiO3_Halpha}
%\end{figure}
